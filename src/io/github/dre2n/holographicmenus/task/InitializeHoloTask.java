...
public class InitializeHoloTask implements Runnable {
	...
	public void run() {
		...
		double menuPositionDistance = menus.getDouble(type
				+ ".positions.distance");
		...
		// Prevent NullPointerException: Add a last page value to the opened
		// menu if it doesn't exist
		...
		Vector vector = playerLocation.getDirection().multiply(
				menuPositionDistance);
		...
		Location menuHead = new Location(menuWorld, menuX, menuY
				+ menuPositionHead, menuZ);
		Location menuLine1 = new Location(menuWorld, menuX, menuY
				+ menuPositionLine1, menuZ);
		Location menuLine2 = new Location(menuWorld, menuX, menuY
				+ menuPositionLine2, menuZ);
		Location menuLine3 = new Location(menuWorld, menuX, menuY
				+ menuPositionLine3, menuZ);
		Location menuSwitch = new Location(menuWorld, menuX, menuY
				+ menuPositionSwitch, menuZ);
		Location menuClose = new Location(menuWorld, menuX, menuY
		...
		VisibilityManager visibilityManagerLine1 = hologramLine1
				.getVisibilityManager();
		VisibilityManager visibilityManagerLine2 = hologramLine2
				.getVisibilityManager();
		VisibilityManager visibilityManagerLine3 = hologramLine3
				.getVisibilityManager();
		VisibilityManager visibilityManagerSwitch = hologramSwitch
				.getVisibilityManager();
		VisibilityManager visibilityManagerClose = hologramClose
				.getVisibilityManager();
		...
		Bukkit.getScheduler().runTask(
				plugin,
				new ManagePageTask(player, type, hologramHead, hologramLine1,
						hologramLine2, hologramLine3, hologramSwitch,
						hologramClose));
