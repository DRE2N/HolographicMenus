		...
		if (type == "line1") {
			text.setTouchHandler(new TouchHandler() {
				...
				public void onTouch(Player player) {
					if (lastPage == 1) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_1_button1, player);
					} else if (lastPage == 2) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_2_button1, player);
					} else if (lastPage == 3) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_3_button1, player);
					} else if (lastPage == 4) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_4_button1, player);
					} else if (lastPage == 5) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_5_button1, player);
					} else if (lastPage == 6) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_6_button1, player);
					} else if (lastPage == 7) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_7_button1, player);
					} else if (lastPage == 8) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_8_button1, player);
					} else if (lastPage == 9) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_9_button1, player);
					} else if (lastPage == 10) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_10_button1, player);
					} else if (lastPage == 11) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_11_button1, player);
					} else if (lastPage == 12) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_12_button1, player);
					} else if (lastPage == 13) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_13_button1, player);
					} else if (lastPage == 14) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_14_button1, player);
					} else if (lastPage == 15) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_15_button1, player);
					} else if (lastPage == 16) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_16_button1, player);
					} else if (lastPage == 17) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_17_button1, player);
					} else if (lastPage == 18) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_18_button1, player);
					} else if (lastPage == 19) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_19_button1, player);
					} else if (lastPage == 20) {
						command = VariableUtil.commandVariables(ConfigStorage.getData().menus_main_commands_page_20_button1, player);
					}
				}
			});
		} else if (type == "line2") {
