...
public class LanguageStorage extends FileUtil {
	...
	public String english_noPermission = "%text%Sorry, but you do not have permission to do this.";
	...
	public String german_noPermission = "%text%Tut mir leid, aber Du hast nicht die Rechte, das zu tun.";
	...
	public String french_noPermission = "%text%Sorry, but you do not have permission to do this.";
