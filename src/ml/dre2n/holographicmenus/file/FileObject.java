...
public abstract class FileObject {
	...
	protected Object loadObject(Field field, ConfigurationSection cs, String path, int depth) throws Exception {
		...
		if(FileObject.class.isAssignableFrom(clazz)&&isConfigurationSection(cs.get(path))) {
			...
			if(FileObject.class.isAssignableFrom(subClazz)||Location.class.isAssignableFrom(subClazz)||Vector.class.isAssignableFrom(subClazz)||Map.class.isAssignableFrom(subClazz)||List.class.isAssignableFrom(subClazz)||subClazz.isEnum()) {
	...
	@SuppressWarnings("rawtypes")
	protected FileObject getConfigObject(Class clazz, ConfigurationSection cs) throws Exception {
	...
	protected ConfigurationSection getConfigObject(FileObject obj, String path, ConfigurationSection cs) throws Exception {
